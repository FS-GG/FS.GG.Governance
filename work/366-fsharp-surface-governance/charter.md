...
# General F# gate for curated signature surfaces, explicit visibility, and API documentation Charter

## Identity
- Work id: `366-fsharp-surface-governance`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 366-fsharp-surface-governance`.

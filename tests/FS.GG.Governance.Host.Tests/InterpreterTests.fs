        ...
        [
            ...
            test "V60 Synthetic emits the three edge outputs and gates only from a Gate base" {
                ...
                try
                    ...
                    Expect.equal
                        (outputKinds env.Outputs)
                        [ "contract"; "explanation"; "route" ]
                        "three F06/F07 outputs once"
                    ...
                    try
                        let inner =
                            Interpreter.run envInner.Ports { defaultConfig with Mode = Inner } change
            ...
            test "V54 Synthetic a verdict round-trips and is frozen against the F04 key" {
                ...
                try
                    ...
                    let recorded =
                        ...
                        |> List.choose (fun fa ->
                            match fa.Value with
                            | Outcome(RuleOutcome.Reviewed rr) -> Some rr
                            | _ -> None)

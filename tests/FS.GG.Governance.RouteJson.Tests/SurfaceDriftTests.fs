...
let private routeJson = SurfaceDrift.assemblyNamed "FS.GG.Governance.RouteJson"
    ...
    testList
        ...
        [
            ...
            test "the public surface is exactly the RouteJson module, nothing private" {
                ...
                Expect.isTrue
                    (typeNames
                     |> Array.exists (fun n -> n.Contains "FS.GG.Governance.RouteJson.RouteJsonModule"))
                    "RouteJson module is public"
            }

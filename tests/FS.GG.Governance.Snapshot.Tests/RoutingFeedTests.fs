...
let tests =
    testList
        ...
        [
            test
                "snapshot.Changed feeds Routing.route unchanged; out-of-root paths are carried, not dropped (SC-001, FR-002)" {
                ...
                Expect.contains
                    ...
                    (GovernedPath "docs/intro.md")
                    "out-of-root path carried"

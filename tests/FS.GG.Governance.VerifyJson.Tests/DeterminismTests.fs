    ...
    testList
        ...
        [
            ...
            testPropertyWithConfig
                fsCheckConfig
                "any real decision projects identically on re-run"
                (fun (decision: ShipDecision) ->
            ...
            testPropertyWithConfig
                fsCheckConfig
                "re-projecting the same decision value is byte-stable"
                (fun (decision: ShipDecision) ->
            ...
            test "no clock/abs-path/username/env content in the emitted document" {
                ...
                for token in [ "/home/"; "/users/"; "c:\\"; "20"; ".tmp"; "machine"; "username" ] do
                    ...
                    if token = "20" then
                        Expect.isFalse
                            (json.Contains "2024" || json.Contains "2025" || json.Contains "2026")
                            "no year-like timestamp"
                    else

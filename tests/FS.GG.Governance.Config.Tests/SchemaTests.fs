        ...
        [
            ...
            test "valid-complete → PolicyFacts" {
                ...
                | Some p ->
                    Expect.equal
                        p.Profiles
                        [ ProfileId "light"; ProfileId "standard"; ProfileId "strict" ]
                        "profiles sorted"
                    ...
                    Expect.equal
                        p.BranchPolicy
                        (Some { Pattern = "main"; RequirePr = true })
                    ...
                    [
                        {
                            ...
                            Capability = DomainId "package-api"
                        }
                        {
                            Glob = GovernedPath "work/**"
                            Capability = DomainId "workflow"
                        }
                    ]

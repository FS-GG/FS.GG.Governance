...
let private relaxVsStrictTestName =
    "relax-vs-strict: Light and Profile.Release report the same base/maturity/mode (US3 AS2)"

let private relaxVsStrictTest =
    testCase relaxVsStrictTestName (fun _ ->
    ...
    testList
        ...
        [
            ...
            testPropertyWithConfig
                fsCheckConfig
                "base severity always carries through (SC-003)"
                (fun (i: EnforcementInput) -> (deriveEffectiveSeverity i).BaseSeverity = i.BaseSeverity)

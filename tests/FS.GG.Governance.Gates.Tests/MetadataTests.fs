...
let tests =
    testList
        ...
        [
            ...
            test
                "command-referencing gate carries the command's declared timeout; command-less → defaultTimeout (SC-005)" {
                ...
                let reg =
                    Gates.buildRegistry (factsOf [ withCmd; without ] [ command "dotnet-test" 600 ])

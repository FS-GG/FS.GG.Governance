    ...
    testList
        ...
        [
            testPropertyWithConfig
                fscheckConfig
                "order-independence: any permutation (List.rev) yields a byte-identical report (SC-005, L-order)"
            ...
            <| fun (gs: Gate list) (s: SensedFacts) ->
                FreshnessResolution.resolve gs s = FreshnessResolution.resolve gs s

    ...
    testList
        ...
        [
            test "assemble pairs the two channels verbatim (example)" {
                let arts =
                    [ digestPayload "sha256:abc"; excerptPayload 100 instructionImitatingText ]
            ...
            testPropertyWithConfig
                fscheckConfig
                "channel separation: r.Instructions = i and r.Artifacts = arts"
                (fun (i: QuestionText) (arts: ArtifactPayload list) ->

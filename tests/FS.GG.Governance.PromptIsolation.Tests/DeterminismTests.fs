    ...
    testList
        ...
        [
            test "render of the same request is byte-identical when repeated" {
                let request =
                    requestOf baseInstructions [ excerptPayload 12 instructionImitatingText; digestPayload "h1" ]
            ...
            test "assemble+render of identical inputs are byte-identical" {
                ...
                let r1 =
                    PromptIsolation.render (PromptIsolation.assemble baseInstructions payloads)
            ...
            testPropertyWithConfig
                fscheckConfig
                "render is a pure function of the request value"
                (fun (r: ReviewRequest) -> PromptIsolation.render r = PromptIsolation.render r)
        ]

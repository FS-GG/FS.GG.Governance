        ...
        [
            test "assemble+render and excerpt are identical across changed cwd and unrelated filesystem state" {
                ...
                try
                    ...
                    Expect.equal
                        (excerptContent duringExcerpt)
                        (excerptContent beforeExcerpt)
                        "excerpt capture is cwd-independent"

                    Expect.equal
                        (excerptTruncation duringExcerpt)
                        (excerptTruncation beforeExcerpt)
                        "excerpt truncation is cwd-independent"
                finally

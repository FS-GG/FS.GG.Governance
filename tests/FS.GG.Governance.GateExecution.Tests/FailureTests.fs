        ...
        [
            ...
            test "real port: a missing executable records startFailureExitCode + a captured diagnostic, no throw" {
                ...
                Expect.equal
                    ...
                    "reified as startFailureExitCode"
            ...
            test
                "real port: a huge TimeoutLimit runs the fast command and records its real exit (no overflow start-failure)" {
                ...
                let record =
                    Interpreter.senseExecution Interpreter.realPort (hugeTimeoutFastCommand ())
            ...
            test "real port: a clean exit whose backgrounded child keeps the pipes open still returns bounded" {
                withTempDir (fun dir ->
                    ...
                    Expect.isLessThan
                        ...
                        15.0
                        "clean-exit drain is bounded, never hangs on the child")
            }
        ]

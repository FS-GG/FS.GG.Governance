    ...
    testList
        ...
        [
            test "an over-budget gate is present and OverBudget — never absent, never Reuse/Recompute" {
                ...
                let report =
                    Budget.decide (Budget.budgetFor Light Inner) Inner [ mustRecompute g High [ RuleHashCat ] ]
            ...
            test
                "budget zero/disabled (Cheap ceiling): every Medium+ MustRecompute is OverBudget; cheap recompute + reuse proceed" {
                ...
                let report =
                    Budget.decide
                        (Budget.budgetFor Light Inner)
                        Inner
                        [ cheapMust; medMust; highMust; exhMust; reuseGate ]
            ...
            test "every over-budget reason carries gate, cost, ceiling, and a class" {
                let report =
                    Budget.decide
                        (Budget.budgetFor Light Inner)
                        Inner
                        [ mustRecompute (gid "d" "x") Exhaustive [ RuleHashCat ] ]

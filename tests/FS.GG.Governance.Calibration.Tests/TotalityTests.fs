    ...
    testList
        ...
        [
            testPropertyWithConfig
                fscheckConfig
                "decide returns a decision and never throws over the full cross-product"
            ...
            test "degenerate / extreme integer thresholds are total" {
                ...
                Expect.equal
                    (Calibration.decide
                        (thresholds System.Int32.MinValue System.Int32.MinValue)
                        (evidenceOf 2 System.Int32.MinValue))
                    (Calibrated
                        {

    ...
    testList
        ...
        [
            test "scaffolded: fixed field order, null refusal, provider, ascending providerOwned generated" {
                let m =
                    scaffoldedManifest "acme.fsharp-lib" [ "src/App/Program.fs"; "src/App/App.fsproj" ]
                ...
                Expect.equal
                    ...
                    "generated ascending by path"

                Expect.isTrue
                    (generatedEntries doc
                     |> List.forall (fun g -> strField g "ownership" = "providerOwned"))
            ...
            test "collision refusal: outcome refused, closed refusal object, collisions array" {
                let m =
                    refusedManifest "acme.fsharp-lib" (Collision [ "src/App/Program.fs" ]) [ "src/App/Program.fs" ]

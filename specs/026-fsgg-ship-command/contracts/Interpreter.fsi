// CONTRACT DRAFT (Phase 1) for specs/026-fsgg-ship-command — the EDGE interpreter of `fsgg ship` (F026).
//
// The shipped Interpreter.fsi (in src/FS.GG.Governance.ShipCommand/) is authored from this draft and is
// the SOLE declaration of the module's public surface (Constitution Principle II). The matching

// CONTRACT DRAFT (Phase 1) for specs/026-fsgg-ship-command — the PURE MVU core of `fsgg ship` (F026).
//
// The shipped Loop.fsi (in src/FS.GG.Governance.ShipCommand/) is authored from this draft and is the
// SOLE declaration of the module's public surface (Constitution Principle II). The matching Loop.fs

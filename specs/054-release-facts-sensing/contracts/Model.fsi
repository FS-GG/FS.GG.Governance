...
// The shipped Model.fsi (in src/FS.GG.Governance.ReleaseFactsSensing/) is authored from this draft and is the
// SOLE declaration of the module's public surface (Constitution Principle II). The matching Model.fs carries NO

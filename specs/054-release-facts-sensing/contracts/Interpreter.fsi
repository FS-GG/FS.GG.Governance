...
// The shipped Interpreter.fsi (in src/FS.GG.Governance.ReleaseFactsSensing/) is the SOLE declaration of the
// module's public surface (Constitution Principle II). The matching Interpreter.fs carries NO
// `private`/`internal`/`public` modifiers — the per-source file readers/parsers and the exception-reifying
// gather helpers live ONLY in the .fs and are absent here.
//

...
def main() -> int:
    ...
    check("target commit exists", lambda: run("git", "cat-file", "-e", f"{TARGET}^{{commit}}"))
    ...
    def tags() -> None:
        ...
        assert refs.get("refs/tags/v1.12.0") == "05279a3092294b0765b1d1ce82d53b3432520362"
    ...
    with tempfile.TemporaryDirectory(prefix="fsgg-418-packages-") as directory:
        root = Path(directory)

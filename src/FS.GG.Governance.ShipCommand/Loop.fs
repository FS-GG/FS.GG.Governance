...
module Loop =
                    ...
                    Ok
                        {
                            ...
                            AuditOut =
                                acc.AuditOut
                                |> Option.defaultValue (CommandHost.under repo "readiness/audit.json")
                            StorePath =
                                acc.Store
    ...
    and emitEffect (model: Model) : Effect =
        ...
        | Text ->
            ...
            | Some decision ->
                let view =
                    ReportView.viewOfShipDecision decision (cacheReportOf model) model.Outcomes

...
// projections of a `Simulate.SimulatedResult`. The JSON is written with `Utf8JsonWriter` (the repo's
// serialization primitive) under a DISTINCT schema id so the real `audit.json` contract stays byte-identical.
